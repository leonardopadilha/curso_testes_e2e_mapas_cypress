...
Cypress.Commands.add('postOrphanage', (orphanage) => {
    ...
    // a função fixture já está preparada para buscar um arquivo na pasta fixtures
    cy.fixture(`images/${orphanage.image}`, 'binary')
        .then((image) => Cypress.Blob.binaryStringToBlob(image, 'image/png')) // Converte a imagem em um blob
        .then((blob) => {
